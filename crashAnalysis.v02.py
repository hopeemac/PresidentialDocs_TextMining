...
print((endTime-startTime)/3600)
sys.stdout.flush()
preCrashKNN=[yList for xList in preCrashKNN for yList in xList if xList!=None]
pd.DataFrame(preCrashKNN).to_csv('./preCrash_knn.csv', index=False, header=False)
...
print((endTime-startTime)/3600)
sys.stdout.flush()
crashKNN=[yList for xList in crashKNN for yList in xList if xList!=None]
pd.DataFrame(crashKNN).to_csv('./crash_knn.csv', index=False, header=False)
...
print((endTime-startTime)/3600)
sys.stdout.flush()
postCrashKNN=[yList for xList in postCrashKNN for yList in xList if xList!=None]
pd.DataFrame(postCrashKNN).to_csv('./postCrash_knn.csv', index=False, header=False)
>>>>>>> 94bf20dd196463c996203b7bbb2cd03bd3a78fb5
